...
if (!$editoroptions)
{
	...
	$params->show_roster_management_options = '1';
	$params->show_urls_images_backend = '0';
	$params->show_urls_images_frontend = '0';
}

// Check if the roster_management uses configuration settings besides global. If so, use them.
if (isset($this->item->attribs['show_publishing_options']) && $this->item->attribs['show_publishing_options'] != '')
{
	$params->show_publishing_options = $this->item->attribs['show_publishing_options'];
}

if (isset($this->item->attribs['show_roster_management_options']) && $this->item->attribs['show_roster_management_options'] != '')
{
	$params->show_roster_management_options = $this->item->attribs['show_roster_management_options'];
}
...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "roster_management.cancel" || document.formvalidator.isValid(document.getElementById("item-form")))
		{
			jQuery("#permissions-sliders select").attr("disabled", "disabled");
			' . $this->form->getField('roster_managementtext')->save() . '
	                          
			Joomla.submitform(task, document.getElementById("item-form"));

			if (task !== "roster_management.apply")
			{
				window.parent.jQuery("#roster_managementEdit' . (int) $this->item->id . 'Modal").modal("hide");
			}
		}
	};
');
...
<?php echo JLayoutHelper::render('components.com_hr.helpers.edit.roster_management',  $this, JPATH_ADMINISTRATOR); ?>      
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_HR_ROSTER_MANAGEMENT_CONTENT')); ?>
		<div class="row-fluid">
			<div class="span9">
				<fieldset class="adminform">
					<?php echo $this->form->getInput('roster_managementtext'); ?>
				</fieldset>
			</div>
			<div class="span3">
		...
		<?php $this->show_options = $params->show_roster_management_options; ?>
