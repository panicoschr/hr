 ...
 * @since  1.6
 */
class HrViewPlans extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			// In plan associations modal we need to remove language filter if forcing a language.
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_HR_PLANS_TITLE'), 'stack plan');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			JToolbarHelper::custom('plans.featured', 'featured.png', 'featured_f2.png', 'JFEATURE', true);
			JToolbarHelper::custom('plans.unfeatured', 'unfeatured.png', 'featured_f2.png', 'JUNFEATURE', true);
		...
		JToolbarHelper::help('JHELP_CONTENT_PLAN_MANAGER');
	}
