 ...
 * @since  1.6
 */
class HrViewPlan extends JViewLegacy
{
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = HrHelper::getActions('com_hr', 'plan', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			JText::_('COM_HR_PAGE_' . ($checkedOut ? 'VIEW_PLAN' : ($isNew ? 'ADD_PLAN' : 'EDIT_PLAN'))),
			'pencil-2 plan-add'
		);
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_hr.plan', $this->item->id);
			}
		...
		JToolbarHelper::help('JHELP_CONTENT_PLAN_MANAGER_EDIT');
	}
}
