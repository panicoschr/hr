...
/**
 * View to edit an position.
 *
 * @since  1.6
 */
class HrViewPosition extends JViewLegacy
{
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = HrHelper::getActions('com_hr', 'position', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			JText::_('COM_HR_PAGE_' . ($checkedOut ? 'VIEW_POSITION' : ($isNew ? 'ADD_POSITION' : 'EDIT_POSITION'))),
			'pencil-2 position-add'
		);
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_hr.position', $this->item->id);
			}
		...
		JToolbarHelper::help('JHELP_CONTENT_POSITION_MANAGER_EDIT');
	}
}
