 ...
 * @since  1.6
 */
class HrViewPositions extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			// In position associations modal we need to remove language filter if forcing a language.
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_HR_POSITIONS_TITLE'), 'stack position');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			JToolbarHelper::custom('positions.featured', 'featured.png', 'featured_f2.png', 'JFEATURE', true);
			JToolbarHelper::custom('positions.unfeatured', 'unfeatured.png', 'featured_f2.png', 'JUNFEATURE', true);
		...
		JToolbarHelper::help('JHELP_CONTENT_POSITION_MANAGER');
	}
