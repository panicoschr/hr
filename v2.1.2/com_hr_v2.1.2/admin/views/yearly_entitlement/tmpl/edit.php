...
if (!$editoroptions)
{
	...
	$params->show_yearly_entitlement_options = '1';
	$params->show_urls_images_backend = '0';
	$params->show_urls_images_frontend = '0';
}

// Check if the yearly_entitlement uses configuration settings besides global. If so, use them.
if (isset($this->item->attribs['show_publishing_options']) && $this->item->attribs['show_publishing_options'] != '')
{
	$params->show_publishing_options = $this->item->attribs['show_publishing_options'];
}

if (isset($this->item->attribs['show_yearly_entitlement_options']) && $this->item->attribs['show_yearly_entitlement_options'] != '')
{
	$params->show_yearly_entitlement_options = $this->item->attribs['show_yearly_entitlement_options'];
}
...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "yearly_entitlement.cancel" || document.formvalidator.isValid(document.getElementById("item-form")))
		{
			jQuery("#permissions-sliders select").attr("disabled", "disabled");
			' . $this->form->getField('yearly_entitlementtext')->save() . '
	                          
			Joomla.submitform(task, document.getElementById("item-form"));

			if (task !== "yearly_entitlement.apply")
			{
				window.parent.jQuery("#yearly_entitlementEdit' . (int) $this->item->id . 'Modal").modal("hide");
			}
		}
	};
');
...
<?php echo JLayoutHelper::render('components.com_hr.helpers.edit.yearly_entitlement',  $this, JPATH_ADMINISTRATOR); ?>      
 
    
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_HR_YEARLY_ENTITLEMENT_CONTENT')); ?>
		<div class="row-fluid">
			<div class="span9">
				<fieldset class="adminform">
					<?php echo $this->form->getInput('yearly_entitlementtext'); ?>
				</fieldset>
			</div>
			<div class="span3">
		...
		<?php $this->show_options = $params->show_yearly_entitlement_options; ?>
