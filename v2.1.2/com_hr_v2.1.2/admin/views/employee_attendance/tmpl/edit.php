...
if (!$editoroptions)
{
	...
	$params->show_employee_attendance_options = '1';
	$params->show_urls_images_backend = '0';
	$params->show_urls_images_frontend = '0';
}

// Check if the employee_attendance uses configuration settings besides global. If so, use them.
if (isset($this->item->attribs['show_publishing_options']) && $this->item->attribs['show_publishing_options'] != '')
{
	$params->show_publishing_options = $this->item->attribs['show_publishing_options'];
}

if (isset($this->item->attribs['show_employee_attendance_options']) && $this->item->attribs['show_employee_attendance_options'] != '')
{
	$params->show_employee_attendance_options = $this->item->attribs['show_employee_attendance_options'];
}
...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "employee_attendance.cancel" || document.formvalidator.isValid(document.getElementById("item-form")))
		{
			jQuery("#permissions-sliders select").attr("disabled", "disabled");
			' . $this->form->getField('employee_attendancetext')->save() . '
	                          
			Joomla.submitform(task, document.getElementById("item-form"));

			if (task !== "employee_attendance.apply")
			{
				window.parent.jQuery("#employee_attendanceEdit' . (int) $this->item->id . 'Modal").modal("hide");
			}
		}
	};
');
...
<?php echo JLayoutHelper::render('components.com_hr.helpers.edit.employee_attendance',  $this, JPATH_ADMINISTRATOR); ?>      
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_HR_EMPLOYEE_ATTENDANCE_CONTENT')); ?>
		<div class="row-fluid">
			<div class="span9">
				<fieldset class="adminform">
					<?php echo $this->form->getInput('employee_attendancetext'); ?>
				</fieldset>
			</div>
			<div class="span3">
		...
		<?php $this->show_options = $params->show_employee_attendance_options; ?>
