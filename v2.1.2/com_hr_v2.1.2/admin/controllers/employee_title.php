...
class HrControllerEmployee_title extends JControllerForm
{
	/**
	 * Class constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		// An employee_title edit form can come from the employee_titles or featured view.
		// Adjust the redirect view on the value of 'return' in the request.
		if ($this->input->get('return') == 'featured')
		{
			$this->view_list = 'featured';
			$this->view_item = 'employee_title&return=featured';
		}
	}
    ...
    public function save($key = null, $urlVar = null) {
        ...
        $model = $this->getModel('employee_title');
  ...
  //      jexit();
        ...
        $url = 'index.php?option=com_hr&view=employee_title&layout=edit';
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_hr.employee_title.' . $recordId))
		{
			return true;
		}

		// Check edit own on the record asset (explicit or inherited)
		if ($user->authorise('core.edit.own', 'com_hr.employee_title.' . $recordId))
		{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Employee_title', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_hr&view=employee_titles' . $this->getRedirectToListAppend(), false));
