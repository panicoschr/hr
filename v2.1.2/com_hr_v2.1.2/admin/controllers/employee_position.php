...
class HrControllerEmployee_position extends JControllerForm
{
	/**
	 * Class constructor.
	 *
	...
	public function __construct($config = array())
	{
		...
		// An employee_position edit form can come from the employee_positions or featured view.
		// Adjust the redirect view on the value of 'return' in the request.
		if ($this->input->get('return') == 'featured')
		{
			$this->view_list = 'featured';
			$this->view_item = 'employee_position&return=featured';
		}
	}
        ...
        $model = $this->getModel('employee_position');
  ...
  //      jexit();
        ...
        $url = 'index.php?option=com_hr&view=employee_position&layout=edit';
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_hr.employee_position.' . $recordId))
		{
			return true;
		}

		// Check edit own on the record asset (explicit or inherited)
		if ($user->authorise('core.edit.own', 'com_hr.employee_position.' . $recordId))
		{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Employee_position', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_hr&view=employee_positions' . $this->getRedirectToListAppend(), false));
